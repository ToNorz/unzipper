...
Report this at @CoupChats if you think this is a mistake, I may unban you
    """
...
Successfully extracted by @UnxBot 🥰
    """
...
Please report this at @CoupChats if you think this is a serious error
    """
...
**How to become a VIP ?**
Contact us at **@CoupChats** for more details
...
If you believe it's an error, report it at **@CoupChats**
    """
...
Please contact @CoupChats with details and screenshots
    """
...
If it fails again, it means that {} haven't started the bot yet (or deleted the chat), or he's private/banned/whatever
    ...
    REPORT_REPLY = "Reply to a message to report it to @CoupChats"

    REPORT_DONE = """
Report sucessfully sent ! An answer will arrive soon

Note : if you need to reply to replies, always use that /report command (or join **@CoupChats**)
    """
...
**/logs** : Send you the logs (all of them). Useful for bug tracking. Send them to **@CoupChats** if you don't understand them/need help

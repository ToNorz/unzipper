...
class Config:
    ...
    # Chunk size for aiohttp URL downloads. Keep this moderate (512 KB) so the
    # asyncio event loop isn't blocked between chunks and progress/cancel callbacks
    # can fire promptly. Pyrogram TG-file downloads manage their own chunk size.
